...
const getDtrByDateRange2 = async (db, employeeId, employmentId, startMoment, endMoment, options) => {
    ...
    days = days.map((_moment) => {
        ...
        const isForCorrection = ['2023-02-02', '2023-02-03', '2023-04-21', '2023-04-22', '2023-12-26', '2024-04-22'].includes(_moment.clone().startOf('day').format('YYYY-MM-DD')) ? true : false
        let dtr = {
            totalMinutes: 0,
            totalInHours: 0,
            renderedDays: 0,
...
const getDtrByDateRange6 = async (db, employeeId, employmentId, _startMoment, _endMoment, options) => {
    ...
    days = days.map((_moment) => {
        ...
        const isForCorrection = ['2023-02-02', '2023-02-03', '2023-04-21', '2023-04-22', '2023-06-01', '2023-06-02', '2023-12-26', '2024-04-22'].includes(_moment.clone().startOf('day').format('YYYY-MM-DD')) ? true : false
