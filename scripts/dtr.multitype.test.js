/**
 * Usage: node scripts/dtr.multitype.test
 */
//// Core modules
...
global.CRED = credLoader.getConfig()
    ...
    ; (async () => {
        try {
            ...
            let attendance = {}
            let dtr = {}
            function Logs(date, type, morningIn, morningOut, afternoonIn, afternoonOut, extendedIn, extendedOut, hours, minutes, sched) {
                this.date = date || '';
            ...
            logs.push(new Logs("2022-01-10", 'normal', '7:30AM', '9:00AM', '3:00PM', '6:00PM'))
            logs.push(new Logs("2022-01-10", 'pass', '7:30AM', '9:00AM', '3:00PM', '6:00PM'))

            schedule = {
                name: 'Staff Schedule',
                timeSegments: [
                    dtrHelper.createTimeSegment('8:00AM', '12:00PM', 0, { weekDays: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'] }),
                    dtrHelper.createTimeSegment('1:00PM', '5:00PM', 0, { weekDays: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'] }),
                ],
            }
